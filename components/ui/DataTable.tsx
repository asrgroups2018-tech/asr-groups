...
export function DataTable<T>({
  ...
  return (
    <div className="bg-white rounded-2xl border border-[#EBE7DF] shadow-[0_2px_8px_rgba(0,0,0,0.03)] overflow-hidden flex flex-col">
      ...
      <div className="p-4 border-b border-[#E6E1D6] flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white">
        {/* Left: Title & Count */}
        ...
        <div className="flex items-center gap-2 flex-1 sm:justify-end w-full sm:w-auto">
          ...
          <button
            ...
            className={`p-1.5 text-xs rounded-xl border transition-colors flex items-center justify-center shrink-0 cursor-pointer ${
          ...
          <button
            ...
            className="px-3 py-1.5 text-xs font-semibold text-slate-700 bg-[#FAF8F5] hover:bg-slate-100 border border-slate-200 rounded-xl flex items-center gap-1.5 transition-colors shrink-0 cursor-pointer shadow-2xs whitespace-nowrap"
